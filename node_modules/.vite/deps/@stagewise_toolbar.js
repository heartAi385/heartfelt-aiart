  ...
  return u$9("div", { className: "flex w-full flex-row items-center justify-center rounded-t-3xl px-3 py-1", children: [
    ...
    u$9(
      H$3,
      {
        ...
        children: [
          "Close menu",
          u$9("div", { className: "rounded-md bg-zinc-600 px-0.5 py-0 text-xs text-zinc-50", children: "esc" })
        ]
      }
    )
  ] });
...
var DraggableProvider = ({
  ...
  return u$9(DraggableContext.Provider, { value: contextValue, children });
};
...
function ToolbarDraggableBox() {
  ...
  return u$9(
    "div",
    {
      ...
      children: u$9("div", { className: "pointer-events-auto flex w-96 max-w-[80vw] flex-col items-start justify-center rounded-3xl border border-border/30 border-solid bg-zinc-50/80 p-0 shadow-lg backdrop-blur-lg transition-colors", children: [
        u$9(ChatArea, {}),
        u$9(
          "div",
          {
...
function ToolbarArea() {
  ...
  return u$9("div", { className: "absolute size-full", children: u$9("div", { className: "absolute inset-4", ref: containerRef, children: u$9(
    DraggableProvider,
    {
      containerRef,
      snapAreas: {

...
var p$4 = {};
var y$7 = [];
var v$3 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
var w$5 = Array.isArray;
function d$5(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function _$4(l2, u2, t2) {
  var i2, r2, o3, e2 = {};
  for (o3 in u2)
    "key" == o3 ? i2 = u2[o3] : "ref" == o3 ? r2 = u2[o3] : e2[o3] = u2[o3];
  if (arguments.length > 2 && (e2.children = arguments.length > 3 ? n$4.call(arguments, 2) : t2), "function" == typeof l2 && null != l2.defaultProps)
    for (o3 in l2.defaultProps)
      null == e2[o3] && (e2[o3] = l2.defaultProps[o3]);
...
function S$5(n2, l2) {
  if (null == l2)
    return n2.__ ? S$5(n2.__, n2.__i + 1) : null;
...
function $$2() {
  for (var n2, u2, t2, r2, o3, f2, c2, s2 = 1; i$8.length; )
    i$8.length > s2 && i$8.sort(e$5), n2 = i$8.shift(), s2 = i$8.length, n2.__d && (t2 = void 0, o3 = (r2 = (u2 = n2).__v).__e, f2 = [], c2 = [], u2.__P && ((t2 = d$5({}, r2)).__v = r2.__v + 1, l$4.vnode && l$4.vnode(t2), O$3(u2.__P, t2, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o3] : null, f2, null == o3 ? S$5(r2) : o3, !!(32 & r2.__u), c2), t2.__v = r2.__v, t2.__.__k[t2.__i] = t2, z$3(f2, t2, c2), t2.__e != o3 && C$5(t2)));
  $$2.__r = 0;
}
function I$4(n2, l2, u2, t2, i2, r2, o3, e2, f2, c2, s2) {
  var a3, h2, v2, w2, d2, g2, _2 = t2 && t2.__k || y$7, m2 = l2.length;
  for (f2 = P$6(u2, l2, _2, f2, m2), a3 = 0; a3 < m2; a3++)
    null != (v2 = u2.__k[a3]) && (h2 = -1 == v2.__i ? p$4 : _2[v2.__i] || p$4, v2.__i = a3, g2 = O$3(n2, v2, h2, i2, r2, o3, e2, f2, c2, s2), w2 = v2.__e, v2.ref && h2.ref != v2.ref && (h2.ref && q$4(h2.ref, null, v2), s2.push(v2.ref, v2.__c || w2, v2)), null == d2 && null != w2 && (d2 = w2), 4 & v2.__u || h2.__k === v2.__k ? f2 = A$4(v2, f2, n2) : "function" == typeof v2.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), v2.__u &= -7);
  return u2.__e = d2, f2;
}
function P$6(n2, l2, u2, t2, i2) {
  var r2, o3, e2, f2, c2, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++)
    null != (o3 = l2[r2]) && "boolean" != typeof o3 && "function" != typeof o3 ? (f2 = r2 + h2, (o3 = n2.__k[r2] = "string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? m$6(null, o3, null, null, null) : w$5(o3) ? m$6(k$3, { children: o3 }, null, null, null) : null == o3.constructor && o3.__b > 0 ? m$6(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : o3).__ = n2, o3.__b = n2.__b + 1, e2 = null, -1 != (c2 = o3.__i = L$4(o3, u2, f2, a3)) && (a3--, (e2 = u2[c2]) && (e2.__u |= 2)), null == e2 || null == e2.__v ? (-1 == c2 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o3.type && (o3.__u |= 4)) : c2 != f2 && (c2 == f2 - 1 ? h2-- : c2 == f2 + 1 ? h2++ : (c2 > f2 ? h2-- : h2++, o3.__u |= 4))) : n2.__k[r2] = null;
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t2 && (t2 = S$5(e2)), B$3(e2, e2));
  return t2;
}
function A$4(n2, l2, u2) {
  ...
  if ("function" == typeof n2.type) {
    for (t2 = n2.__k, i2 = 0; t2 && i2 < t2.length; i2++)
      t2[i2] && (t2[i2].__ = n2, l2 = A$4(t2[i2], l2, u2));
    return l2;
  }
...
function L$4(n2, l2, u2, t2) {
  ...
  if (null === f2 && null == n2.key || f2 && o3 == f2.key && e2 == f2.type && 0 == (2 & f2.__u))
    return u2;
  if (t2 > (null != f2 && 0 == (2 & f2.__u) ? 1 : 0))
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) {
      if (i2 >= 0) {
        if ((f2 = l2[i2]) && 0 == (2 & f2.__u) && o3 == f2.key && e2 == f2.type)
          return i2;
        i2--;
      }
      if (r2 < l2.length) {
        if ((f2 = l2[r2]) && 0 == (2 & f2.__u) && o3 == f2.key && e2 == f2.type)
          return r2;
        r2++;
      }
    }
    ...
    if ("style" == l2)
      if ("string" == typeof u2)
        ...
        if ("string" == typeof t2 && (n2.style.cssText = t2 = ""), t2)
          for (l2 in t2)
            u2 && l2 in u2 || T$6(n2.style, l2, "");
        if (u2)
          for (l2 in u2)
            t2 && u2[l2] == t2[l2] || T$6(n2.style, l2, u2[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      r2 = l2 != (l2 = l2.replace(f$9, "$1")), l2 = l2.toLowerCase() in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t2 ? u2.u = t2.u : (u2.u = c$7, n2.addEventListener(l2, r2 ? a$b : s$9, r2)) : n2.removeEventListener(l2, r2 ? a$b : s$9, r2);
    else {
...
function O$3(n2, u2, t2, i2, r2, o3, e2, f2, c2, s2) {
  ...
  n:
    if ("function" == typeof j2)
      try {
        if (b2 = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i2, t2.__c ? m2 = (h2 = u2.__c = t2.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b2, M2) : (u2.__c = h2 = new x$5(b2, M2), h2.constructor = j2, h2.render = D$3), C2 && C2.sub(h2), h2.props = b2, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d$5({}, h2.__s)), d$5(h2.__s, j2.getDerivedStateFromProps(b2, h2.__s))), y2 = h2.props, v2 = h2.state, h2.__v = u2, p2)
        ...
        if (h2.context = M2, h2.props = b2, h2.__P = n2, h2.__e = false, P2 = l$4.__r, A2 = 0, S2) {
          for (h2.state = h2.__s, h2.__d = false, P2 && P2(u2), a3 = h2.render(h2.props, h2.state, h2.context), H2 = 0; H2 < h2._sb.length; H2++)
      ...
      null == o3 && u2.__v == t2.__v ? (u2.__k = t2.__k, u2.__e = t2.__e) : f2 = u2.__e = V$2(t2.__e, u2, t2, i2, r2, o3, e2, c2, s2);
  return (a3 = l$4.diffed) && a3(u2), 128 & u2.__u ? void 0 : f2;
}
function z$3(n2, u2, t2) {
  for (var i2 = 0; i2 < t2.length; i2++)
    q$4(t2[i2], t2[++i2], t2[++i2]);
...
function V$2(u2, t2, i2, r2, o3, e2, f2, c2, s2) {
  ...
  if ("svg" == x2 ? o3 = "http://www.w3.org/2000/svg" : "math" == x2 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != e2) {
    for (a3 = 0; a3 < e2.length; a3++)
      if ((d2 = e2[a3]) && "setAttribute" in d2 == !!x2 && (x2 ? d2.localName == x2 : 3 == d2.nodeType)) {
        u2 = d2, e2[a3] = null;
        break;
      }
  }
  ...
  if (null == x2)
    ...
    if (e2 = e2 && n$4.call(u2.childNodes), b2 = i2.props || p$4, !c2 && null != e2)
      for (b2 = {}, a3 = 0; a3 < u2.attributes.length; a3++)
        b2[(d2 = u2.attributes[a3]).name] = d2.value;
    for (a3 in b2)
      if (d2 = b2[a3], "children" == a3)
        ;
    ...
    for (a3 in k2)
      d2 = k2[a3], "children" == a3 ? v2 = d2 : "dangerouslySetInnerHTML" == a3 ? h2 = d2 : "value" == a3 ? _2 = d2 : "checked" == a3 ? m2 = d2 : c2 && "function" != typeof d2 || b2[a3] === d2 || j$5(u2, a3, d2, b2[a3], o3);
    if (h2)
      c2 || y2 && (h2.__html == y2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t2.__k = [];
    else if (y2 && (u2.innerHTML = ""), I$4("template" == t2.type ? u2.content : u2, w$5(v2) ? v2 : [v2], t2, i2, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o3, e2, f2, e2 ? e2[0] : i2.__k && S$5(i2, 0), c2, s2), null != e2)
      for (a3 = e2.length; a3--; )
        g$4(e2[a3]);
...
function J$4(l2, u2, t2) {
  ...
  for (o3 in l2.type && l2.type.defaultProps && (e2 = l2.type.defaultProps), u2)
    "key" == o3 ? i2 = u2[o3] : "ref" == o3 ? r2 = u2[o3] : f2[o3] = null == u2[o3] && null != e2 ? e2[o3] : u2[o3];
...
n$4 = y$7.slice, l$4 = { __e: function(n2, l2, u2, t2) {
  for (var i2, r2, o3; l2 = l2.__; )
    if ((i2 = l2.__c) && !i2.__)
      try {
        if ((r2 = i2.constructor) && null != r2.getDerivedStateFromError && (i2.setState(r2.getDerivedStateFromError(n2)), o3 = i2.__d), null != i2.componentDidCatch && (i2.componentDidCatch(n2, t2 || {}), o3 = i2.__d), o3)
          return i2.__E = i2;
      } catch (l3) {
        n2 = l3;
      }
...
function g$3() {
  var n2 = p$3(t$5++, 11);
  if (!n2.__) {
    for (var u2 = r$4.__v; null !== u2 && !u2.__m && null !== u2.__; )
      u2 = u2.__;
...
var PluginContext = K$3([]);
function PluginProvider({
  children,
  plugins
}) {
  return u$9(PluginContext.Provider, { value: plugins, children });
}
function usePlugins() {
...
var O$2 = { map: L$3, forEach: L$3, count: function(n2) {
...
var q$2 = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103;
var G$2 = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;
var J$3 = /^on(Ani|Tra|Tou|BeforeInp|Compo)/;
var K$2 = /[A-Z0-9]/g;
...
}, useCallback: q$3, useContext: x$4, useDebugValue: P$5, useDeferredValue: w$3, useEffect: y$6, useId: g$3, useImperativeHandle: F$5, useInsertionEffect: I$3, useLayoutEffect: _$3, useMemo: T$5, useReducer: h$5, useRef: A$3, useState: d$4, useSyncExternalStore: C$3, useTransition: k$1 } } };
var vn = "18.3.1";
function dn(n2) {
...
typeof window !== "undefined" ? window.WebSocket : __require2("ws").WebSocket;
...
var WebSocketImpl2 = typeof window !== "undefined" ? window.WebSocket : __require2("ws").WebSocket;
...
function SRPCBridgeProvider({
  ...
  return u$9(SRPCBridgeContext.Provider, { value: state, children });
}
...
var isPrimitive = (payload) => isBoolean(payload) || isNull(payload) || isUndefined(payload) || isNumber$1(payload) || isString$1(payload) || isSymbol(payload);
...
var ChatStateProvider = ({ children }) => {
  ...
  return u$9(ChatContext.Provider, { value, children });
};
...
var LocationContext = K$3(new URL(window.location.href));
function LocationProvider({
  ...
  return u$9(LocationContext.Provider, { value: currentUrl, children });
}
function ContextProviders({
  children,
  config
}) {
  return u$9(LocationProvider, { children: u$9(SRPCBridgeProvider, { children: u$9(PluginProvider, { plugins: (config == null ? void 0 : config.plugins) || [], children: u$9(ChatStateProvider, { children }) }) }) });
}
...
function $507fabe10e71c6fb$var$handleFocusEvent(e2) {
  if (e2.target === window || e2.target === document || $8a9cb279dc87e130$export$fda7da73ab5d4c48 || !e2.isTrusted)
    return;
  ...
  let { hoverProps, triggerHoverEnd } = T$5(() => {
    let triggerHoverStart = (event, pointerType) => {
      ...
      addGlobalListener($431fbd86ca7dc216$export$b204af158042fbac(event.target), "pointerover", (e2) => {
        if (state.isHovered && state.target && !$d4ee10de306f2510$export$4282f70798064fe0(state.target, e2.target))
...
var O$1 = ((a3) => (a3[a3.None = 0] = "None", a3[a3.RenderStrategy = 1] = "RenderStrategy", a3[a3.Static = 2] = "Static", a3))(O$1 || {});
var A$1 = ((e2) => (e2[e2.Unmount = 0] = "Unmount", e2[e2.Hidden = 1] = "Hidden", e2))(A$1 || {});
function L$2() {
  let n2 = U$2();
...
function F$3(n2, r2 = {}, e2, a3, s2) {
  ...
  if (t2 === k$3 && (Object.keys(m$4(o3)).length > 0 || Object.keys(m$4(u2)).length > 0))
    if (!mn(f2) || Array.isArray(f2) && f2.length > 1) {
      if (Object.keys(m$4(o3)).length > 0)
        throw new Error(['Passing props on "Fragment"!', "", `The current component <${a3} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(m$4(o3)).concat(Object.keys(m$4(u2))).map((d2) => `  - ${d2}`).join(`
...
function x$2(r2, e2) {
  ...
  if (n$3(() => {
    if (r2)
      return t2.dispatch("ADD", i2), () => t2.dispatch("REMOVE", i2);
  }, [t2, r2]), !r2)
    return false;
  let s2 = h2.indexOf(i2), o3 = h2.length;
  return s2 === -1 && (s2 = o3, o3 += 1), s2 === o3 - 1;
}
var f$4 = /* @__PURE__ */ new Map();
var u$4 = /* @__PURE__ */ new Map();
function h$3(t2) {
  var e2;
...
function m$3(t2) {
  ...
  if (r2 === 1 ? u$4.delete(t2) : u$4.set(t2, r2 - 1), r2 !== 1)
    return;
  let e2 = f$4.get(t2);
...
function y$4(t2, { allowed: r2, disallowed: e2 } = {}) {
  ...
  n$3(() => {
    ...
    if (!i2)
      return;
    let a3 = o$5();
    for (let n2 of (d2 = e2 == null ? void 0 : e2()) != null ? d2 : [])
      n2 && a3.add(h$3(n2));
    ...
    for (let n2 of s2) {
      ...
      for (; o3 && o3 !== l2.body; ) {
        for (let p2 of o3.children)
          s2.some((E2) => p2.contains(E2)) || a3.add(h$3(p2));
        o3 = o3.parentElement;
      }
    }
    return a3.dispose;
...
var f$3 = ["[contentEditable=true]", "[tabindex]", "a[href]", "area[href]", "button:not([disabled])", "iframe", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])"].map((e2) => `${e2}:not([tabindex='-1'])`).join(",");
var p = ["[data-autofocus]"].map((e2) => `${e2}:not([tabindex='-1'])`).join(",");
var F$2 = ((n2) => (n2[n2.First = 1] = "First", n2[n2.Previous = 2] = "Previous", n2[n2.Next = 4] = "Next", n2[n2.Last = 8] = "Last", n2[n2.WrapAround = 16] = "WrapAround", n2[n2.NoScroll = 32] = "NoScroll", n2[n2.AutoFocus = 64] = "AutoFocus", n2))(F$2 || {});
var T$2 = ((o3) => (o3[o3.Error = 0] = "Error", o3[o3.Overflow = 1] = "Overflow", o3[o3.Success = 2] = "Success", o3[o3.Underflow = 3] = "Underflow", o3))(T$2 || {});
var y$3 = ((t2) => (t2[t2.Previous = -1] = "Previous", t2[t2.Next = 1] = "Next", t2))(y$3 || {});
...
function P(e2, r2, { sorted: t2 = true, relativeTo: u2 = null, skipElements: o3 = [] } = {}) {
  ...
  let n2 = (() => {
    ...
    if (r2 & 1)
      return 0;
    if (r2 & 2)
      return Math.max(0, l2.indexOf(u2)) - 1;
    if (r2 & 4)
      return Math.max(0, l2.indexOf(u2)) + 1;
    if (r2 & 8)
      return l2.length - 1;
...
function R$1(p2, f2, C2) {
  let u2 = x$2(p2, "outside-click"), m2 = s$6(C2), s2 = q$3(function(e2, n2) {
    if (e2.defaultPrevented)
      return;
    let r2 = n2(e2);
    if (r2 === null || !r2.getRootNode().contains(r2) || !r2.isConnected)
      return;
    let h2 = function l2(o3) {
      return typeof o3 == "function" ? l2(o3()) : Array.isArray(o3) || o3 instanceof Set ? o3 : [o3];
    }(f2);
    for (let l2 of h2)
      if (l2 !== null && (l2.contains(r2) || e2.composed && e2.composedPath().includes(l2)))
        return;
  ...
  i$3(u2, "touchstart", (t2) => {
    ...
    if (!(Math.abs(e2.x - a3.current.x) >= E || Math.abs(e2.y - a3.current.y) >= E))
      return s2(t2, () => t2.target instanceof HTMLElement ? t2.target : null);
...
function e$1(t2, u2) {
  return T$5(() => {
    ...
    if (typeof r2 == "string" && r2.toLowerCase() === "button" || (u2 == null ? void 0 : u2.tagName) === "BUTTON" && !u2.hasAttribute("type"))
      return "button";
  }, [t2.type, t2.as, u2]);
}
function d$1() {
...
var a$5 = a$6(() => /* @__PURE__ */ new Map(), { PUSH(e2, n2) {
  var o3;
...
function a$4(r2, e2, n2 = () => ({ containers: [] })) {
  ...
  return n$3(() => {
    if (!(!e2 || !r2))
      return a$5.dispatch("PUSH", e2, n2), () => a$5.dispatch("POP", e2, n2);
  }, [r2, e2]), i2;
}
...
var FloatingNodeContext = K$3(null);
var FloatingTreeContext = K$3(null);
var useFloatingParentNodeId = () => {
  var _React$useContext;
  return ((_React$useContext = x$4(FloatingNodeContext)) == null ? void 0 : _React$useContext.id) || null;
};
var useFloatingTree = () => x$4(FloatingTreeContext);
...
var y$2 = K$3({ styles: void 0, setReference: () => {
}, setFloating: () => {
...
function Me({ children: e2, enabled: t2 = true }) {
  ...
  let { refs: b2, floatingStyles: w2, context: g2 } = useFloating({ open: i2, placement: a3 === "selection" ? p2 === "center" ? "bottom" : `bottom-${p2}` : p2 === "center" ? `${a3}` : `${a3}-${p2}`, strategy: "absolute", transform: false, middleware: [offset({ mainAxis: a3 === "selection" ? 0 : E2, crossAxis: v2 }), shift({ padding: c2 }), a3 !== "selection" && flip({ padding: c2 }), a3 === "selection" && P2 ? inner({ ...P2, padding: c2, overflowRef: u2, offset: r2, minItemsVisible: q$1, referenceOverflowThreshold: c2, onFallbackChange(h2) {
    ...
    for (let m2 of (W2 = (O2 = g2.elements.floating) == null ? void 0 : O2.childNodes) != null ? W2 : [])
...
var a$3 = (t2, e2, r2) => (f$1(t2, e2, "read from private field"), r2 ? r2.call(t2) : e2.get(t2));
var l$2 = (t2, e2, r2) => {
  if (e2.has(t2))
    throw TypeError("Cannot add the same private member more than once");
  e2 instanceof WeakSet ? e2.add(t2) : e2.set(t2, r2);
};
var c$2 = (t2, e2, r2, n2) => (f$1(t2, e2, "write to private field"), e2.set(t2, r2), r2);
var i$1;
var s$4;
var o$1;
var m = class {
  ...
  send(e2) {
    ...
    for (let r2 of a$3(this, s$4).get(e2.type))
      r2(a$3(this, i$1), e2);
  }
};
...
function u$1(t2, e2) {
  do {
    ...
    if (r2.done && n2.done)
      return true;
    if (r2.done || n2.done || !Object.is(r2.value, n2.value))
      return false;
  } while (true);
}
function S$2(t2) {
...
function j(t2) {
  let o3 = a$2(), n2 = x$4(b$1), [r2, u2] = d$4(() => {
    var s2, a3;
    if (!o3 && n2 !== null)
      return (s2 = n2.current) != null ? s2 : null;
    if (s$7.isServer)
      return null;
...
var k = K$1(q);
var B = K$1(X);
var oe = Object.assign(k, { Group: B });
function s$1(n2, t2) {
  ...
  if (n$3(() => {
    ...
    r2 && (e2.current = r2);
  }, [n2, t2]), t2 == null || !n2 || t2 === document.activeElement)
    return false;
...
var M = ((t2) => (t2[t2.Open = 0] = "Open", t2[t2.Closed = 1] = "Closed", t2))(M || {});
var T = ((t2) => (t2[t2.Pointer = 0] = "Pointer", t2[t2.Other = 1] = "Other", t2))(T || {});
var b = ((i2) => (i2[i2.OpenMenu = 0] = "OpenMenu", i2[i2.CloseMenu = 1] = "CloseMenu", i2[i2.GoToItem = 2] = "GoToItem", i2[i2.Search = 3] = "Search", i2[i2.ClearSearch = 4] = "ClearSearch", i2[i2.RegisterItems = 5] = "RegisterItems", i2[i2.UnregisterItems = 6] = "UnregisterItems", i2[i2.SetButtonElement = 7] = "SetButtonElement", i2[i2.SetItemsElement = 8] = "SetItemsElement", i2[i2.SortItems = 9] = "SortItems", i2))(b || {});
...
var F = { [1](e2) {
  ...
  if (n2.focus === c$1.Nothing)
    return { ...t2, activeItemIndex: null };
  if (n2.focus === c$1.Specific)
    return { ...t2, activeItemIndex: e2.items.findIndex((i2) => i2.id === n2.id) };
  if (n2.focus === c$1.Previous) {
    ...
    if (i2 !== null) {
      ...
      if (o3 !== null) {
        ...
        if (((m2 = g2.current) == null ? void 0 : m2.previousElementSibling) === s2.current || ((d2 = s2.current) == null ? void 0 : d2.previousElementSibling) === null)
          return { ...t2, activeItemIndex: o3 };
      }
    }
    ...
    if (i2 !== null) {
      ...
      if (o3 !== null) {
        let s2 = e2.items[o3].dataRef.current.domRef;
        if (((a3 = g2.current) == null ? void 0 : a3.nextElementSibling) === s2.current || ((I2 = s2.current) == null ? void 0 : I2.nextElementSibling) === null)
          return { ...t2, activeItemIndex: o3 };
      }
    }
  }
  ...
  for (let [u2, m2] of t2.entries())
    if (l2.has(m2.id) && (r2.push(u2), l2.delete(m2.id), l2.size === 0))
      break;
  if (r2.length > 0) {
    t2 = t2.slice();
    for (let u2 of r2.reverse())
      t2.splice(u2, 1);
  }
...
var x = class _x extends m {
  ...
  static new({ __demoMode: t2 = false } = {}) {
    return new _x({ __demoMode: t2, menuState: t2 ? 0 : 1, buttonElement: null, itemsElement: null, items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1, pendingShouldSort: false, pendingFocus: { focus: c$1.Nothing } });
  }
  reduce(t2, r2) {
...
var et = "div";
var tt = O$1.RenderStrategy | O$1.Static;
function ot(T2, E2) {
  ...
  let q2 = p$2(), se = o$4((e2) => {
    ...
    switch (q2.dispose(), e2.key) {
      case o$3.Space:
        if (t2.state.searchQuery !== "")
          return e2.preventDefault(), e2.stopPropagation(), t2.send({ type: b.Search, value: e2.key });
      case o$3.Enter:
...
function rt(T$12, E2) {
  ...
  n$3(() => {
    if (t2)
      return o$5().requestAnimationFrame(() => {
        var u2, J2;
  ...
  let g2 = o$4(() => {
    ...
    if (n2)
      return o3.send({ type: b.GoToItem, focus: c$1.Nothing });
...
var yt = K$1(pt);
var Et = K$1(ut);
var to = Object.assign(dt, { Button: mt, Items: Tt, Item: ft, Section: ct, Heading: yt, Separator: Et });
var L = "textarea";
function H(s2, l2) {
...
var __iconNode$6 = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]];
var ChevronDown = createLucideIcon("chevron-down", __iconNode$6);
var __iconNode$5 = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]];
var ChevronUp = createLucideIcon("chevron-up", __iconNode$5);
var __iconNode$4 = [
  ["circle", { cx: "12", cy: "12", r: "1", key: "41hilf" }],
  ["circle", { cx: "19", cy: "12", r: "1", key: "1wjl8i" }],
  ["circle", { cx: "5", cy: "12", r: "1", key: "1pcz8c" }]
];
var Ellipsis = createLucideIcon("ellipsis", __iconNode$4);
var __iconNode$3 = [
...
var Minimize2 = createLucideIcon("minimize-2", __iconNode$3);
var __iconNode$2 = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
  ["path", { d: "M12 5v14", key: "s699le" }]
];
var Plus = createLucideIcon("plus", __iconNode$2);
var __iconNode$1 = [
  [
    "path",
    {
...
var Send = createLucideIcon("send", __iconNode$1);
var __iconNode = [
...
var Trash2 = createLucideIcon("trash-2", __iconNode);
var ChatArea = M$3(() => {
  const { chatAreaState } = useChatState();
  if (chatAreaState === "hidden")
    return null;
  return u$9(ChatAreaBox, { children: [
    u$9(ChatAreaResizeBar, {}),
    chatAreaState === "compact" && u$9(ChatAreaCompact, {}),
    chatAreaState === "expanded" && u$9(ChatAreaExpanded, {})
  ] });
});
var ChatAreaBox = M$3(({ children }) => u$9("div", { className: "h-auto w-full overflow-x-hidden", children }));
var ChatAreaResizeBar = M$3(() => {
  ...
  return u$9("div", { className: "flex w-full flex-row items-center justify-center rounded-t-3xl px-3 py-1", children: [
    u$9(
      H$3,
      {
        ...
        children: chatAreaState === "compact" ? u$9(ChevronUp, { className: "size-5" }) : u$9(ChevronDown, { className: "size-5" })
      }
    ),
    u$9(
      H$3,
      {
        ...
        children: [
          "Close menu",
          u$9("div", { className: "rounded-md bg-muted-foreground px-0.5 py-0 text-xs text-zinc-50", children: "esc" })
        ]
      }
    )
  ] });
});
var ChatAreaCompact = M$3(() => u$9("div", { className: "flex w-full flex-col gap-1 p-3", children: u$9("span", { className: "text-sm text-zinc-950/50", children: "This is the compact chat area... Showing just the last response from the assistant." }) }));
var ChatAreaExpanded = M$3(() => {
  ...
  return u$9("div", { className: "flex max-h-[50vh] w-full flex-col gap-3 p-3 pb-0", children: [
    u$9("div", { className: "flex flex-1 flex-col gap-2 overflow-y-auto p-1", children: currentChat == null ? void 0 : currentChat.messages.map((message) => u$9(
      "div",
      {
    ...
    u$9("div", { className: "flex flex-row items-center justify-start gap-2 overflow-x-auto overflow-y-visible border-border/10 border-t pt-2 pb-2", children: [
      !hasNewChat && u$9(
        H$3,
        {
          className: "h-6 flex-shrink-0 rounded-full bg-zinc-950/5 px-2 font-semibold text-foreground text-xs",
          onClick: handleCreateChat,
          children: u$9(Plus, { className: "size-3" })
        }
      ),
      chats.map((chat) => u$9(
        H$3,
...
var has = function(str1, str2) {
  if (typeof str1 === OBJ_TYPE && str1.length > 0) {
    for (var i2 in str1) {
      if (lowerize(str1[i2]) == lowerize(str2))
        return true;
    }
    return false;
  }
...
function ChatBox() {
  ...
  const handleSubmit = q$3(() => {
    if (!currentChat || !currentInput.trim())
      return;
      ...
      children: [
        ...
        u$9(
          H$3,
          {
            ...
            children: u$9(Send, { className: "size-3" })
          }
        )
      ]
    }
...
var DropdownMenu = to;
var DropdownMenuButton = D$1(
  (props, ref) => {
    return u$9(mt, { as: k$3, ref, ...props });
  }
);
var DropdownMenuContent = D$1(
  (props, ref) => {
    return u$9(
      Tt,
      {
...
var DropdownMenuItemStyles = "w-full flex flex-row select-none items-center justify-start gap-2 p-2 pr-6 truncate overflow-hidden rounded-md hover:bg-zinc-950/10 focus:text-zinc-900 cursor-pointer transition-color duration-150 text-sm font-normal text-foreground";
var DropdownMenuButttonItem = D$1(
  (props, ref) => {
    return u$9(ft, { ref, children: u$9(
      H$3,
      {
        ...props,
...
D$1(
  (props, ref) => {
    return u$9(ft, { ref, children: u$9("a", { ...props, className: cn(DropdownMenuItemStyles, props.className) }) });
  }
);
function ToolbarItem(props) {
  return u$9("div", { className: "flex h-full shrink-0 items-center justify-center", children: [
    props.children,
    props.badgeContent && u$9(
      "div",
      {
        className: cn(
...
function ToolbarSection({ children }) {
  return u$9("div", { className: "fade-in slide-in-from-bottom-2 flex max-h-full max-w-sm animate-in snap-start flex-row items-center justify-between gap-2 border-x border-r-border/30 border-l-transparent px-3 first:pl-0 last:border-r-transparent last:pr-0", children });
}
function MoreActionsButton() {
  ...
  return u$9(ToolbarSection, { children: u$9(DropdownMenu, { children: [
    u$9(DropdownMenuButton, { children: u$9(ToolbarButton, { children: u$9(Ellipsis, { className: "size-4" }) }) }),
    u$9(DropdownMenuContent, { children: [
      pluginTools.map((tool) => u$9(DropdownMenuButttonItem, { onClick: tool.execute, children: tool.name })),
      u$9(DropdownMenuButttonItem, { onClick: minimizeCompanion, children: [
        u$9(Minimize2, { className: "size-4" }),
        "Minimize companion"
      ] })
    ] })
  ] }) });
...
function ToolbarDraggableBox() {
  return u$9("div", { className: "-translate-x-1/2 pointer-events-auto absolute bottom-5 left-1/2 p-0.5", children: u$9("div", { className: "pointer-events-auto flex w-96 max-w-[80vw] flex-col items-start justify-center rounded-3xl border border-border/30 border-solid bg-zinc-50/80 p-0 shadow-lg backdrop-blur-lg transition-colors", children: [
    u$9(ChatArea, {}),
    u$9("div", { className: "flex w-full flex-row items-center justify-center rounded-3xl border-border/30 border-t bg-background/40 p-1.5 shadow-lg transition-colors first:border-none", children: [
      u$9(ChatBox, {}),
      u$9(MoreActionsButton, {})
    ] })
  ] }) });
}
var DraggableContext = K$3(null);
var DraggableProvider = ({
  ...
  return u$9(DraggableContext.Provider, { value: { borderLocation, snapAreas }, children });
};
function ToolbarArea() {
  const containerRef = A$3(null);
  return u$9("div", { className: "absolute size-full", ref: containerRef, children: u$9(
    DraggableProvider,
    {
      containerRef,
      snapAreas: {
      ...
      children: u$9(ToolbarDraggableBox, {})
    }
  ) });
}
var Logo = ({
  ...
  return u$9(
    "div",
    {
      ...
      children: [
        color === "gradient" && u$9("div", { className: "absolute inset-0", children: [
          u$9("div", { className: "absolute inset-0 size-full bg-gradient-to-tr from-indigo-700 via-blue-500 to-teal-500" }),
          u$9("div", { className: "absolute top-1/2 left-1/2 size-9/12 bg-[radial-gradient(circle,rgba(219,39,119,0.2)_0%,rgba(219,39,119,0)_100%)]" }),
          u$9("div", { className: "absolute right-1/2 bottom-1/2 size-full bg-[radial-gradient(circle,rgba(219,39,119,0.2)_0%,rgba(219,39,119,0)_100%)]" }),
          u$9("div", { className: "absolute top-0 left-[-10%] size-[120%] bg-[radial-gradient(circle,rgba(255,255,255,0)_60%,rgba(255,255,255,0.2)_70%)]" }),
          u$9("div", { className: "absolute top-[-20%] left-0 h-[120%] w-full bg-[radial-gradient(circle,rgba(55,48,163,0)_55%,rgba(55,48,163,0.35)_73%)]" })
        ] }),
        u$9(
          "svg",
          {
...
function ExpandButton() {
  ...
  return u$9(
    "button",
    {
      ...
      children: u$9(Logo, { color: "gradient" })
    }
  );
}
function ElementSelector(props) {
  ...
  const handleMouseMove = q$3(
    (event) => {
      ...
      if (target.closest(".companion"))
        return;
      const refElement = getElementAtPoint(event.clientX, event.clientY);
      if (props.ignoreList.includes(refElement))
        return;
  ...
  const handleMouseClick = q$3(() => {
    if (!lastHoveredElement.current)
      return;
    if (props.ignoreList.includes(lastHoveredElement.current))
      return;
...
function ContextItemProposal({
  ...
  return u$9(
    "div",
    {
      ...
      ref: boxRef,
      children: u$9(Plus, { className: "size-6 drop-shadow-black drop-shadow-md" })
    }
  );
}
function ContextItem({ refElement, ...props }) {
  ...
  return u$9(
    "div",
    {
      ...
      role: "button",
      tabIndex: 0,
      children: u$9(Trash2, { className: "size-6 drop-shadow-black drop-shadow-md" })
    }
  );
}
function SelectorCanvas() {
  ...
  if (!shouldShow)
    return null;
  return u$9(k$3, { children: [
    hoveredElement && u$9(ContextItemProposal, { refElement: hoveredElement }),
    u$9(
      ElementSelector,
      {
    ...
    contextElements.map((el) => u$9(ContextItem, { refElement: el }))
  ] });
}
function DesktopLayout() {
  const minimized = useAppState((state) => state.minimized);
  return u$9("div", { className: cn("fixed inset-0 h-screen w-screen"), children: [
    u$9(SelectorCanvas, {}),
    !minimized && u$9(ToolbarArea, {}),
    minimized && u$9(ExpandButton, {})
  ] });
}
...
function App(config) {
  ...
  return u$9(k$3, { children: [
    ...
    u$9(ContextProviders, { config, children: [
      u$9(HotkeyListener, {}),
      u$9(VisibilityManager, { children: u$9(DesktopLayout, {}) })
    ] })
  ] });
}
...
@stagewise/toolbar/dist/index.js:
  (**
   * @license React
